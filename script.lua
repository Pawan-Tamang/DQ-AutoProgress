...
-- Fully Auto-Execute Compatible Version
...
task.spawn(function()
	...
	task.wait(3) -- give the game more time to fully load (important for auto-exec)
	...
	if not PlayerGui then
		warn("[DQ AutoProgress] PlayerGui not found")
		return
	end
	...
	StatusLabel.Text = "Auto-starting in 6 seconds...\n(You can still change settings)"
	...
	print("[DQ AutoProgress] Successfully loaded and will auto-start.")
end)
